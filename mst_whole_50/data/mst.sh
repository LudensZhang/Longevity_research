...
mst(){
    ...
    expert search -i centenarian/query.h5 -m ../model/centenarian/independent_model -o ../result/centenarian/independent_result_$1
    expert search -i centenarian/query.h5 -m ../model/centenarian/transfer_model -o ../result/centenarian/transfer_result_$1
    ...
    expert search -i elder/query.h5 -m ../model/elder/independent_model -o ../result/elder/independent_result_$1
    expert search -i elder/query.h5 -m ../model/elder/transfer_model -o ../result/elder/transfer_result_$1
}

for bootstrap in {0..99..1}
do
mst $bootstrap 
echo "$bootstrap bootstrap has been done" 
done