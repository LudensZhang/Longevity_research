...
inde.Data <- read.csv('independent_result/layerMelt.csv') 
trans.Data <- read.csv('transfer_result/layerMelt.csv')
...
trans.box.Plot <- ggplot(trans.Data)+
                ...
                theme(text=element_text(size=30),
                        ...
                        legend.position=(c(0.9, 0.9)),
                        legend.key.size=unit(1, 'cm'))
ggsave('transfer_box_plot_Centenarian.jpg', height=10, width=15)